...
2. Yol
select from ogrenciler where isim in('Derya Soylu', 'Yavuz Bal');
...
insert into calisanlar values(10007, 'CAN', 5000, '2018-04-14'); -- isim unique değil
insert into calisanlar values(10009, 'Cem', '', '2018-04-14'); -- data türü int olmalı
insert into calisanlar values('', 'osman', 2000, '2018-04-14');
insert into calisanlar values('', 'osman can', 2000, '2018-04-14'); -- id hiçlik atamıştı zaten unique olmaz artık
insert into calisanlar values('', 'veli can', 6000, '2018-04-14'); -- id hiçlik atamıştı zaten unique olmaz artık
insert into calisanlar values(10002, 'ayse Yılmaz', 12000, '2018-04-14'); --10002 primary key değil
insert into calisanlar values(null, 'filiz', 12000, '2018-04-14'); -- isim null olmaz çünkü primary key olmalıdır
...
--SORU 2: .child tablosuna ted_verginosu 105 olan veri girişi yapınız.
   -- Bu mümkün değil çünkü parent tabloda olmayan primary key ile child tabloya
   -- veri girişi yapılamaz
   
insert into child values(105, 300, 'Motor', 'Haşim'); --> error
...
delete from parent where vergi_no = 101; -->error
...
--Kural: Child tablosundaki silinmeden parent tablosundaki silinemez
